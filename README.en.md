...
* Compatibility: a single codebase for **Contao 4.13 LTS** and **Contao 5.3+** (incl. 5.4–5.7), **PHP 8.2+**
...
- Runs from a single codebase on **Contao 4.13 LTS** and **Contao 5.3+**
  (incl. 5.4–5.7); originally TYPOlight / Contao 2–3.
